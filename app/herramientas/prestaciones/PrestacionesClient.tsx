...
// Cada prestación enlaza a su artículo en el lector de LexGT.
const ARTICLE_HREF: Record<string, string> = {
  indemnizacion: '/leyes/codigo-de-trabajo#articulo-82',
  vacaciones: '/leyes/codigo-de-trabajo#articulo-130',
}
              ...
              {result.lines.map((line) => (
                <li key={line.key} className="flex items-start justify-between gap-4 py-3">
                  <div className="min-w-0">
                    ...
                    {ARTICLE_HREF[line.key] ? (
                      <Link
                        href={ARTICLE_HREF[line.key]}
                        className="text-[11px] text-navy-700 underline-offset-2 hover:underline"
                      >
                        {line.basis}
                      </Link>
                    ) : (
